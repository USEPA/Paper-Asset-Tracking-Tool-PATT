...
WHERE 1 ".$searchQuery." AND active <> 1 group by a.request_id ".$searchHaving.") t");
...
WHERE 1 ".$searchQuery." AND active <> 1 group by request_id ".$searchHaving." order by ".$columnName." ".$columnSortOrder." limit ".$row.",".$rowperpage;
