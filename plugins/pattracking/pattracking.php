...
if ( ! class_exists( 'Patt_Tracking' ) ) :
  ...
  final class Patt_Tracking {
    ...
    public function includes() {
        ...
        // Add EIDW CRON
        add_action( 'wppatt_eidw_cron', array($frontend, 'wpatt_eidw_cron_schedule')); 
        // Message Cleanup CRON
        add_action( 'private_message_cleanup_cron.php', array($frontend, 'wppatt_private_message_cleanup'));
